...
class ADE20KDataset(Dataset):
    """PyTorch Dataset for the preprocessed ADE20K segmentation dataset."""
    ...
    def __init__(self, processed_data_path: str, transform=None, mask_transform=None, max_samples: Optional[int] = None, dino_cache_dir: Optional[str] = None):
        ...
        # Load class names
        class_names_path = os.path.join(os.path.dirname(processed_data_path), "ade20k_class_names.json")
    ...
    def __getitem__(self, idx) -> Dict[str, Union[torch.Tensor, List[str]]]:
